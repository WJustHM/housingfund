...
public enum SubjectEnum {
    ...
    增值收益("311", "增值收益"),
    增值收益分配("321", "增值收益分配"),
    待分配增值收益("32104", "待分配增值收益"),
    增值收益分配_提取贷款风险准备金("32101", "增值收益分配-提取贷款风险准备金"),
    增值收益分配_提取公积金中心管理费用("32102", "增值收益分配-提取公积金中心管理费用"),
    增值收益分配_城市廉租住房补充资金("32103", "增值收益分配-城市廉租住房补充资金"),
    业务收入("401", "业务收入"),
    ...
    SubjectEnum(String id, String name) {
        this.id = id;
        this.name = name;
    }
