...
import com.handge.housingfund.common.service.collection.model.Error;
...
//        }}).build();
    ...
    public static <T> ResponseEntity<T>  buildCommonEntityResponse(T entity){ return new ResponseEntity<>(entity);}
