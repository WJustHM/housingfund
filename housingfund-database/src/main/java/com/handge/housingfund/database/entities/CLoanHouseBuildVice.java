...
/**
 * HHouseBuildVice generated by hbm2java
 */
@Entity
@Table(name = "c_loan_house_build_vice")
@org.hibernate.annotations.Table(appliesTo = "c_loan_house_build_vice", comment = "房屋自建、翻修信息表")
public class CLoanHouseBuildVice extends Common implements java.io.Serializable {

	private static final long serialVersionUID = -6724159355377554604L;
//	@OneToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
//	@JoinColumn(name = "GRYWMX", columnDefinition = "VARCHAR(32) DEFAULT NULL COMMENT '个人业务明细'")
	@OneToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "loanHouseBuildVice")
	...
	@Column(name = "JZCS", columnDefinition = "VARCHAR(3) DEFAULT NULL COMMENT '建造层数'")
	private String jzcs;
	...
	public CLoanHouseBuildVice() {
		super();

	}

	public CLoanHouseBuildVice(String id, Date created_at, Date updated_at, Date deleted_at, Boolean deleted,
			CLoanHousingBusinessProcess HHousingBusinessProcess, String pzjgwh, BigDecimal jhjzfy, String jzcs,
			Date jhkgrq, Date jhjgrq, String tdsyzh, String jzgcghxkzh, String jzydghxkzh, String jsgcsgxkzh,
			BigDecimal grsyzj, String fwzl, BigDecimal jchjzmj, String fwjg, String fwxz, String grskyhzh,
			String khhyhmc, String yhkhm, String blzl) {
		this.id = id;
