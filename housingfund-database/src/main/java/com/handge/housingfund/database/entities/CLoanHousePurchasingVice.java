...
/**
 * HHousePurchasingVice generated by hbm2java
 */
@Entity
@Table(name = "c_loan_house_purchasing_vice")
@org.hibernate.annotations.Table(appliesTo = "c_loan_house_purchasing_vice", comment = "房屋购买信息副表")
public class CLoanHousePurchasingVice extends Common implements java.io.Serializable {

	private static final long serialVersionUID = -1239535643862548535L;
//	@OneToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
//	@JoinColumn(name = "GRYWMX", columnDefinition = "VARCHAR(32) DEFAULT NULL COMMENT '个人业务明细'")
	@OneToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "loanHousePurchasingVice")
	...
	public CLoanHousePurchasingVice() {
		super();
	}

	public CLoanHousePurchasingVice(String id, Date created_at, Date updated_at, Date deleted_at, Boolean deleted,
			CLoanHousingBusinessProcess HHousingBusinessProcess, String lpmc, BigDecimal htje, BigDecimal fwzj,
			String gfhtbh, BigDecimal fwjzmj, BigDecimal fwtnmj, BigDecimal sfk, String fwxz, String fwxs, String fwjg,
			Date fwjgrq, String sfrzhhm, String sfrkhyhmc, String sfryhkhm, BigDecimal yfk, String grskyhzh,
			String khyhmc, String yhkhm, boolean sfwesf, String blzl, BigDecimal danJia) {
		this.id = id;
