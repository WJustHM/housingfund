 ...
 */
@XmlRootElement(name = "LatestInventory")
@XmlAccessorType(XmlAccessType.FIELD)
public class LatestInventory implements Serializable {
    ...
    private InventoryChangeList changeMessage;
    ...
    public InventoryChangeList getChangeMessage() {
        return changeMessage;
    }

    public void setChangeMessage(InventoryChangeList changeMessage) {
