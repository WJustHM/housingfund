...
@XmlRootElement(name = "HandleTransferListModle")
@XmlAccessorType(XmlAccessType.FIELD)
public class HandleTransferListModle  implements Serializable{
  ...
  private ArrayList<HandleTransferListModleResults> results;//
  ...
  /**
   **/
  public ArrayList<HandleTransferListModleResults> getResults() { return results;}

  public void setResults(ArrayList<HandleTransferListModleResults> results) {this.results = results;}
  ...
  public String toString()  {
      ...
      sb.append("class HandleTransferListModle {\n");
  ...
  public void checkValidation(){
      ...
      for(HandleTransferListModleResults element: results == null ? new ArrayList<HandleTransferListModleResults>():results){
