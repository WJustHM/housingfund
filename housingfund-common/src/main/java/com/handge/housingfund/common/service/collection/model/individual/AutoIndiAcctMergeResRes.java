...
@XmlRootElement(name = "AutoIndiAcctMergeResRes")
@XmlAccessorType(XmlAccessType.FIELD)
public class AutoIndiAcctMergeResRes  implements Serializable{
   ...
   public String toString(){ 
       ...
       return "AutoIndiAcctMergeResRes{" +  
