...
@XmlRootElement(name = "GetLoanRecordDetailsResponsesGuaranteeContractInformationPledgeInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetLoanRecordDetailsResponsesGuaranteeContractInformationPledgeInformation  implements Serializable {
    ...
    public String toString() {
        ...
        return "GetLoanRecordDetailsResponsesGuaranteeContractInformationPledgeInformation{" +
