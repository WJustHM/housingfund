...
@XmlRootElement(name = "ConfirmPaymentPut")
@XmlAccessorType(XmlAccessType.FIELD)
public class ConfirmPaymentPut  implements Serializable {

    private String DKFFRQ;  //贷款发放日期

   // private String YWLSH;  //业务流水号

    private String FKYHMC;  //放款银行名称（0：建设银行 1：中国银行 2：交通银行 3：农业银行 4：工商银行）
