...
@XmlRootElement(name = "收到银行利息")
@XmlAccessorType(XmlAccessType.FIELD)
public class SDYHLX implements Serializable {
...
//    @XmlElement(name = "资金详情")
    ...
    public SDYHLX(String YHMC, String YHTZD, String YHZH, String FSSJ, String FSE, String BZ, List<String> fuJian, List<TableRow> tableRows) {
        this.YHMC = YHMC;
        this.YHTZD = YHTZD;
        this.YHZH = YHZH;
        this.FSSJ = FSSJ;
