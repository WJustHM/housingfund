...
@XmlRootElement(name = "TransferOutAuditedListModle")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferOutAuditedListModle  implements Serializable{
  ...
  private ArrayList<TransferOutAuditedListModleResults> results;//
  ...
  private void defaultConstructor(){
      ...
      this.setResults(new ArrayList<TransferOutAuditedListModleResults>(){
        {
            this.add(new TransferOutAuditedListModleResults(){
              {
  ...
  /**
   **/
  public ArrayList<TransferOutAuditedListModleResults> getResults() { return results;}

  public void setResults(ArrayList<TransferOutAuditedListModleResults> results) {this.results = results;}
  ...
  public String toString()  {
      ...
      sb.append("class TransferOutAuditedListModle {\n");
  ...
  public void checkValidation(){
      ...
      for(TransferOutAuditedListModleResults element: results == null ? new ArrayList<TransferOutAuditedListModleResults>():results){
