...
@XmlRootElement(name = "UnitPayWrongPost")
@XmlAccessorType(XmlAccessType.FIELD)
public class UnitPayWrongPost  implements Serializable{
   ...
   private  ArrayList<UnitPayWrongPostGZXX>    GZXX;  //更正信息 
   ...
   public  ArrayList<UnitPayWrongPostGZXX> getGZXX(){ 
   ...
   public  void setGZXX(ArrayList<UnitPayWrongPostGZXX>  GZXX){ 
