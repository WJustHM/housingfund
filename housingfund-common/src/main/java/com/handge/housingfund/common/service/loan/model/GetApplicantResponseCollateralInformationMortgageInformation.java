...
@XmlRootElement(name = "GetApplicantResponseCollateralInformationMortgageInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetApplicantResponseCollateralInformationMortgageInformation  implements Serializable {
    ...
    public String toString() {
        return "GetApplicantResponseCollateralInformationMortgageInformation{" +
