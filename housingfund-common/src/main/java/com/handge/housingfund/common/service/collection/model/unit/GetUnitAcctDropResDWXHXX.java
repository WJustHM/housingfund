...
@XmlRootElement(name = "GetUnitAcctDropResDWXHXX")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetUnitAcctDropResDWXHXX  implements Serializable{
    ...
    public String toString() {
        ...
        return "GetUnitAcctDropResDWXHXX{" +
