...
@XmlRootElement(name = "AutoRemittanceInventoryResYJEZHJ")
@XmlAccessorType(XmlAccessType.FIELD)
public class AutoRemittanceInventoryResYJEZHJ  implements Serializable{
   ...
   public String toString(){ 
       ...
       return "AutoRemittanceInventoryResYJEZHJ{" +  
