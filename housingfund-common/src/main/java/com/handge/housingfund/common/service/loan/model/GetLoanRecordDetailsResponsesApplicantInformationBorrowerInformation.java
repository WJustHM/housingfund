...
@XmlRootElement(name = "GetLoanRecordDetailsResponsesApplicantInformationBorrowerInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetLoanRecordDetailsResponsesApplicantInformationBorrowerInformation  implements Serializable {
    ...
    public String toString() {
        ...
        return "GetLoanRecordDetailsResponsesApplicantInformationBorrowerInformation{" +
