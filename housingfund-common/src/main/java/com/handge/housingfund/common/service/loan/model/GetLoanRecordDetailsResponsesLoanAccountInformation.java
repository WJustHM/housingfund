...
@XmlRootElement(name = "GetLoanRecordDetailsResponsesLoanAccountInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetLoanRecordDetailsResponsesLoanAccountInformation  implements Serializable {
   ...
   private  String    DQJHGHBJ;  //当期计划归还本金
    ...
    private  String    DQJHGHLX;  //当期计划归还利息
   ...
   public String toString(){ 
       ...
       return "GetLoanRecordDetailsResponsesLoanAccountInformation{" +  
 
              "DQJHGHBJ='" + this.DQJHGHBJ + '\'' + "," +
              "HSLXZE='" + this.HSLXZE + '\'' + "," +
              "DQJHGHLX='" + this.DQJHGHLX + '\'' + "," +
              "DQYQQS='" + this.DQYQQS + '\'' + "," +
              "YQBJZE='" + this.YQBJZE + '\'' + "," +
              "SYQS='" + this.SYQS + '\'' + "," +
              "DKQS='" + this.DKQS + '\'' + "," +
              ...
              "DKFFE='" + this.DKFFE + '\'' + "," +
              "DQYHJE='" + this.DQYHJE + '\'' + "," +
              "DQJHHKJE='" + this.DQJHHKJE + '\'' + "," +
              "DQYHBJ='" + this.DQYHBJ + '\'' + "," +
              "TQGHBJZE='" + this.TQGHBJZE + '\'' + "," +
              "HSBJZE='" + this.HSBJZE + '\'' + "," +
              "LJYQQS='" + this.LJYQQS + '\'' + 
