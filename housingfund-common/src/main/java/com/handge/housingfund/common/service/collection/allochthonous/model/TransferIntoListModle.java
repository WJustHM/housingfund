...
@XmlRootElement(name = "TransferIntoListModle")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferIntoListModle  implements Serializable{
  ...
  private ArrayList<TransferIntoListModleResults> results;//
  ...
  private void defaultConstructor(){
      ...
      this.setResults(new ArrayList<TransferIntoListModleResults>(){
        {
            this.add(new TransferIntoListModleResults(){
              {
  ...
  /**
   **/
  public ArrayList<TransferIntoListModleResults> getResults() { return results;}

  public void setResults(ArrayList<TransferIntoListModleResults> results) {this.results = results;}
  ...
  public String toString()  {
      ...
      sb.append("class TransferIntoListModle {\n");
  ...
  public void checkValidation(){
      ...
      for(TransferIntoListModleResults element: results == null ? new ArrayList<TransferIntoListModleResults>():results){
