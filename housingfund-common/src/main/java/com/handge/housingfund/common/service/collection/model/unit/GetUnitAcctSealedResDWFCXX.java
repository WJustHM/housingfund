...
@XmlRootElement(name = "GetUnitAcctSealedResDWFCXX")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetUnitAcctSealedResDWFCXX implements Serializable {
    ...
    public void setDWFCYY(String DWXHYY) {
    ...
    public String toString() {
        return "GetUnitAcctSealedResDWFCXX{" +
                "JBRZJLX='" + JBRZJLX + '\'' +
                ", YWLSH='" + YWLSH + '\'' +
                ", DWFRDBXM='" + DWFRDBXM + '\'' +
