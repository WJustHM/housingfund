...
@XmlRootElement(name = "TransferOutPostModleAccountMsg")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferOutPostModleAccountMsg  implements Serializable{
  ...
  public String toString()  {
      ...
      sb.append("class TransferOutPostModleAccountMsg {\n");
  ...
  public void checkValidation(){
      ...
      if (!StringUtil.notEmpty(SFCZPTPD)){

         throw new ErrorException(ReturnEnumeration.Parameter_MISS,"是否存在骗提骗贷");
      }

      if (!StringUtil.notEmpty(YWBLLXDH)){

         throw new ErrorException(ReturnEnumeration.Parameter_MISS,"业务办理联系电话");
      }

      if (!StringUtil.notEmpty(FKXX)){

         throw new ErrorException(ReturnEnumeration.Parameter_MISS,"反馈信息");
      }
  }
}
