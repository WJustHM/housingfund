...
@XmlRootElement(name = "TransferIntoPostModleWorkerMsg")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferIntoPostModleWorkerMsg  implements Serializable{
  ...
  public String toString()  {
      ...
      sb.append("class TransferIntoPostModleWorkerMsg {\n");
  ...
  public void checkValidation(){
      ...
      if (!StringUtil.notEmpty(ZJLX)){

         throw new ErrorException(ReturnEnumeration.Parameter_MISS,"证件类型");
      }

      if (!StringUtil.notEmpty(ZJHM)){

         throw new ErrorException(ReturnEnumeration.Parameter_MISS,"证件号码");
      }
  }
}
