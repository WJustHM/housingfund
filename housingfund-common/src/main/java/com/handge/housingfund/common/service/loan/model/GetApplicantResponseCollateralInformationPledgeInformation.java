...
@XmlRootElement(name = "GetApplicantResponseCollateralInformationPledgeInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetApplicantResponseCollateralInformationPledgeInformation  implements Serializable {
   ...
   public String toString(){ 
       ...
       return "GetApplicantResponseCollateralInformationPledgeInformation{" +  
