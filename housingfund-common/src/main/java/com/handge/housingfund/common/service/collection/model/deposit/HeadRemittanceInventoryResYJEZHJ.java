...
@XmlRootElement(name = "HeadRemittanceInventoryResYJEZHJ")
@XmlAccessorType(XmlAccessType.FIELD)
public class HeadRemittanceInventoryResYJEZHJ  implements Serializable{
   ...
   public String toString(){ 
       ...
       return "HeadRemittanceInventoryResYJEZHJ{" +  
