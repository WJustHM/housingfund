...
@XmlRootElement(name = "ListUnitDepositRatioResRes")
@XmlAccessorType(XmlAccessType.FIELD)
public class ListUnitDepositRatioResRes  implements Serializable{

    private static final long serialVersionUID = 1277577586910918721L;
   ...
   public String toString(){ 
       ...
       return "ListUnitDepositRatioResRes{" +  
