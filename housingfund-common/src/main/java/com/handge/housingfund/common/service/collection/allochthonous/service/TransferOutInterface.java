...
public interface TransferOutInterface{
   ...
   */
  public HandleContactLetterListModle handleContactLetterList(TokenContext tokenContext, final String LXHBH, final String ZGXM, final String ZJHM, final String zhuangTai, final String ZRGJJZXMC, final String KSSJ, final String JSSJ, final String pageNo, final String pageSize);
   ...
   * @param pageSize 当前页数数据条数
   */
  public ReceiveContactLetterListModle receiveContactLetterList(TokenContext tokenContext, final String LXHBH, final String ZGXM, final String ZJHM, final String KSSJ, final String JSSJ, final String pageNo, final String pageSize);
   ...
   * @param body 
   */
  public CommonResponses transferOutConfirmation(TokenContext tokenContext, final String YWLSH, final TransferOutConfirmationModle body);
   ...
   * @param body 
   */
  public CommonResponses transferOutReject(TokenContext tokenContext, final String YWLSH, final TransferOutRejectModle body);
