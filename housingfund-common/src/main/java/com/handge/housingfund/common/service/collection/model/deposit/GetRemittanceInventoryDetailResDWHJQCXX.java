...
@XmlRootElement(name = "GetRemittanceInventoryDetailResDWHJQCXX")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetRemittanceInventoryDetailResDWHJQCXX  implements Serializable{
   ...
   public String toString(){ 
       ...
       return "GetRemittanceInventoryDetailResDWHJQCXX{" +  
