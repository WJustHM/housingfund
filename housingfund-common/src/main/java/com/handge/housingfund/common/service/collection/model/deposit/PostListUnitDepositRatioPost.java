...
@XmlRootElement(name = "PostListUnitDepositRatioPost")
@XmlAccessorType(XmlAccessType.FIELD)
public class PostListUnitDepositRatioPost  implements Serializable{

    private static final long serialVersionUID = -8549404082946888216L;
   ...
   public String toString(){ 
       ...
       return "PostListUnitDepositRatioPost{" +  
