...
@XmlRootElement(name = "TransferIntoDetailsModleTurnIntoMsg")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferIntoDetailsModleTurnIntoMsg  implements Serializable{
  ...
  public String toString()  {
      ...
      sb.append("class TransferIntoDetailsModleTurnIntoMsg {\n");
