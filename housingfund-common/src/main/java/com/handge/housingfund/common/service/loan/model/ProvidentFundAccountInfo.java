 ...
 */
@XmlRootElement(name = "ProvidentFundAccountInfo")
@XmlAccessorType(XmlAccessType.FIELD)
public class ProvidentFundAccountInfo  implements Serializable {

    private static final long serialVersionUID = 2351268324048568577L;
    private String  JZNY;
