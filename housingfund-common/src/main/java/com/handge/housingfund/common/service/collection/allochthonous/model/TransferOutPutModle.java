...
@XmlRootElement(name = "TransferOutPutModle")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferOutPutModle  implements Serializable{
  ...
  private TransferOutPutModleTurnOutFundsAccountMsg TurnOutFundsAccountMsg;//
  ...
  private void defaultConstructor(){
      ...
      this.setTurnOutFundsAccountMsg(new TransferOutPutModleTurnOutFundsAccountMsg(){
        {
  ...
  /**
   **/
  public TransferOutPutModleTurnOutFundsAccountMsg getTurnOutFundsAccountMsg() { return TurnOutFundsAccountMsg;}

  public void setTurnOutFundsAccountMsg(TransferOutPutModleTurnOutFundsAccountMsg TurnOutFundsAccountMsg) {this.TurnOutFundsAccountMsg = TurnOutFundsAccountMsg;}
  ...
  public String toString()  {
      ...
      sb.append("class TransferOutPutModle {\n");
