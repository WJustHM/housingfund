...
@XmlRootElement(name = "HousingRecordListGetInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class HousingRecordListGetInformation  implements Serializable {

    private static final long serialVersionUID = -2160932781279523825L;
    ...
    public String toString() {
        return "HousingRecordListGetInformation{" +
                "YWLSH='" + YWLSH + '\'' +
                ", FSE='" + FSE + '\'' +
                ", DKYWMXLX='" + DKYWMXLX + '\'' +
                ", BJJE='" + BJJE + '\'' +
