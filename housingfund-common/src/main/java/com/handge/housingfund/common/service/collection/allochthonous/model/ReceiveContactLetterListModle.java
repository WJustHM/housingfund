...
@XmlRootElement(name = "ReceiveContactLetterListModle")
@XmlAccessorType(XmlAccessType.FIELD)
public class ReceiveContactLetterListModle  implements Serializable{
  ...
  private ArrayList<ReceiveContactLetterListModleResults> results;//
  ...
  /**
   **/
  public ArrayList<ReceiveContactLetterListModleResults> getResults() { return results;}

  public void setResults(ArrayList<ReceiveContactLetterListModleResults> results) {this.results = results;}
  ...
  public String toString()  {
      ...
      sb.append("class ReceiveContactLetterListModle {\n");
  ...
  public void checkValidation(){
      ...
      for(ReceiveContactLetterListModleResults element: results == null ? new ArrayList<ReceiveContactLetterListModleResults>():results){
