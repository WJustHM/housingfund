...
@XmlRootElement(name = "GetLoanRecordDetailsResponsesOverhaulContractInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetLoanRecordDetailsResponsesOverhaulContractInformation  implements Serializable {
    ...
    public void setJHFXZJ(String JHFXZJ) {
    ...
    public String toString() {
        ...
        return "GetLoanRecordDetailsResponsesOverhaulContractInformation{" +
