...
@XmlRootElement(name = "GetIndiAcctAlterResGRZHXX")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetIndiAcctAlterResGRZHXX  implements Serializable{

   private  String    GRJCJS;  //个人缴存基数

   private  String    GJJSCHJNY;  //公积金首次汇缴年月 

   private  String    GRCKZHKHYHMC;  //个人存款账户开户银行名
   ...
   public String toString(){ 
       ...
       return "GetIndiAcctAlterResGRZHXX{" +  
