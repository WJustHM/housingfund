...
@XmlRootElement(name = "GetLoanRecordDetailsResponsesCapitalInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetLoanRecordDetailsResponsesCapitalInformation  implements Serializable {
    ...
    public String toString() {
        return "GetLoanRecordDetailsResponsesCapitalInformation{" +
                "HKFS='" + HKFS + '\'' +
                ", HTDKJE='" + HTDKJE + '\'' +
                ", LLFSBL='" + LLFSBL + '\'' +
                ", HTDKJEDX='" + HTDKJEDX + '\'' +
