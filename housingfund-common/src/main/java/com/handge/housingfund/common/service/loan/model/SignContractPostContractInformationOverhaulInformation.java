...
@XmlRootElement(name = "SignContractPostContractInformationOverhaulInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class SignContractPostContractInformationOverhaulInformation  implements Serializable {
   ...
   public String toString(){ 
       ...
       return "SignContractPostContractInformationOverhaulInformation{" +  
