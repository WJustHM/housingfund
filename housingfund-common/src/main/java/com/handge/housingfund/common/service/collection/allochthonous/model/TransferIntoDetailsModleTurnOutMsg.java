...
@XmlRootElement(name = "TransferIntoDetailsModleTurnOutMsg")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferIntoDetailsModleTurnOutMsg  implements Serializable{
  ...
  public String toString()  {
      ...
      sb.append("class TransferIntoDetailsModleTurnOutMsg {\n");
