...
@XmlRootElement(name = "TransferIntoNegotiationModle")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferIntoNegotiationModle  implements Serializable{
  ...
  public String toString()  {
      ...
      sb.append("class TransferIntoNegotiationModle {\n");
