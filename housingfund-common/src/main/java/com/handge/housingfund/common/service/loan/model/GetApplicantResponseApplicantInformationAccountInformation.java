...
@XmlRootElement(name = "GetApplicantResponseApplicantInformationAccountInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetApplicantResponseApplicantInformationAccountInformation  implements Serializable {
    ...
    public String toString() {
        return "GetApplicantResponseApplicantInformationAccountInformation{" +
                "GRZHZT='" + GRZHZT + '\'' +
                ", JZNY='" + JZNY + '\'' +
                ", YJCE='" + YJCE + '\'' +
                ", GRZHYE='" + GRZHYE + '\'' +
