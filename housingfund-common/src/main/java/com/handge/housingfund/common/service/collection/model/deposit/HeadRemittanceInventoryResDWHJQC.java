...
@XmlRootElement(name = "HeadRemittanceInventoryResDWHJQC")
@XmlAccessorType(XmlAccessType.FIELD)
public class HeadRemittanceInventoryResDWHJQC  implements Serializable{
   ...
   public String toString(){ 
       ...
       return "HeadRemittanceInventoryResDWHJQC{" +  
