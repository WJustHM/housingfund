...
@XmlRootElement(name = "GetApplicantResponseHouseInformationBuildInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetApplicantResponseHouseInformationBuildInformation  implements Serializable {
    ...
    public String toString() {
        return "GetApplicantResponseHouseInformationBuildInformation{" +
                "GRSKYHZH='" + GRSKYHZH + '\'' +
                ", FWXZ='" + FWXZ + '\'' +
                ", FWJG='" + FWJG + '\'' +
                ", JHJGRQ='" + JHJGRQ + '\'' +
