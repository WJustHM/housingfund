...
@XmlRootElement(name = "ApplicantPostApplicantInformationInformationAccountInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class ApplicantPostApplicantInformationInformationAccountInformation  implements Serializable {
   ...
   public String toString(){ 
       ...
       return "ApplicantPostApplicantInformationInformationAccountInformation{" +  
