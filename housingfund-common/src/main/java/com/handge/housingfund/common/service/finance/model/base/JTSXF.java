...
@XmlRootElement(name = "计提手续费")
@XmlAccessorType(XmlAccessType.FIELD)
public class JTSXF implements Serializable {
...
//    @XmlElement(name = "资金详情")
    ...
    public JTSXF(String JTNY, String FSE, String BZ, List<String> fuJian, List<TableRow> tableRows) {
        this.JTNY = JTNY;
        this.FSE = FSE;
        this.BZ = BZ;
        FuJian = fuJian;
