...
@XmlRootElement(name = "GetApplicantResponseApplicantInformationBorrowerInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetApplicantResponseApplicantInformationBorrowerInformation  implements Serializable {
   ...
   public String toString(){ 
       ...
       return "GetApplicantResponseApplicantInformationBorrowerInformation{" +  
