...
@XmlRootElement(name = "HeadIndiAcctSetRes")
@XmlAccessorType(XmlAccessType.FIELD)
public class HeadIndiAcctSetRes implements Serializable {
    ...
    private String GGJSCHJNY;  //公积金首次汇缴年月
    ...
    public String getGGJSCHJNY() {

        return this.GGJSCHJNY;

    }


    public void setGGJSCHJNY(String GGJSCHJNY) {

        this.GGJSCHJNY = GGJSCHJNY;
    ...
    public String toString() {
        ...
        return "HeadIndiAcctSetRes{" +

            "GRJCJS='" + this.GRJCJS + '\'' + "," +
            "ZhiWu='" + this.ZhiWu + '\'' + "," +
            "CSNY='" + this.CSNY + '\'' + "," +
            "GGJSCHJNY='" + this.GGJSCHJNY + '\'' + "," +
            "ZJLX='" + this.ZJLX + '\'' + "," +
            "GRYJCE='" + this.GRYJCE + '\'' + "," +
            "GRZH='" + this.GRZH + '\'' + "," +
            "RiQi='" + this.RiQi + '\'' + "," +
