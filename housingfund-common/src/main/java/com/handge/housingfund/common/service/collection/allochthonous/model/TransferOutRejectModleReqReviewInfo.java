...
@XmlRootElement(name = "TransferOutRejectModleReqReviewInfo")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferOutRejectModleReqReviewInfo  implements Serializable{
  

  private String BHJG;//驳回结果
   ...
   * 驳回结果
   **/
  public String getBHJG() { return BHJG;}

  public void setBHJG(String BHJG) {this.BHJG = BHJG;}
  ...
  public String toString()  {
      ...
      sb.append("class TransferOutRejectModleReqReviewInfo {\n");
      sb.append("BHJG:").append(BHJG).append("\n");
