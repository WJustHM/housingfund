...
@XmlRootElement(name = "TransferInCancelModleReviewInfo")
@XmlAccessorType(XmlAccessType.FIELD)
public class TransferInCancelModleReviewInfo  implements Serializable{
  ...
  public String toString()  {
      ...
      sb.append("class TransferInCancelModleReviewInfo {\n");
