 ...
 */
@XmlRootElement(name = "期末结转业务支出")
@XmlAccessorType(XmlAccessType.FIELD)
public class QMJZYWZC implements Serializable {
...
//    @XmlElement(name = "资金详情")
    ...
    public QMJZYWZC(String QSSJ, String JSSJ, String FSE, String BZ, List<String> fuJian, List<TableRow> tableRows) {
        this.QSSJ = QSSJ;
        this.JSSJ = JSSJ;
        this.FSE = FSE;
        this.BZ = BZ;
