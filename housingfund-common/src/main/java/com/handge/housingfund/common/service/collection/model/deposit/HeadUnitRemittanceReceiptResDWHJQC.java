...
@XmlRootElement(name = "HeadUnitRemittanceReceiptResDWHJQC")
@XmlAccessorType(XmlAccessType.FIELD)
public class HeadUnitRemittanceReceiptResDWHJQC  implements Serializable{
   ...
   public String toString(){ 
       ...
       return "HeadUnitRemittanceReceiptResDWHJQC{" +  
