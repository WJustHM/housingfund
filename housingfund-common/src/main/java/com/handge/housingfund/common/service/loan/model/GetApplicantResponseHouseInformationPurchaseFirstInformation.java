...
@XmlRootElement(name = "GetApplicantResponseHouseInformationPurchaseFirstInformation")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetApplicantResponseHouseInformationPurchaseFirstInformation  implements Serializable {
    ...
    public String toString() {
        return "GetApplicantResponseHouseInformationPurchaseFirstInformation{" +
                "FWJZMJ='" + FWJZMJ + '\'' +
                ", FWZL='" + FWZL + '\'' +
                ", FWTNMJ='" + FWTNMJ + '\'' +
                ", FWXS='" + FWXS + '\'' +
